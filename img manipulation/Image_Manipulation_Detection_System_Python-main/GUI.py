...
def browseFile():
    ...
    blank_img = getImage("Image_Manipulation_Detection_System_Python-main/images/output.png", IMG_WIDTH, IMG_HEIGHT)
...
def copy_move_forgery():
    ...
    if forgery is None:
        ...
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/no_copy_move.png", IMG_WIDTH, IMG_HEIGHT)
        ...
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/copy_move.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def metadata_analysis():
    ...
    if img_exif is None:
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/no_metadata.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/metadata.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def noise_variance_inconsistency():
    ...
    if(noise_forgery):
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/varience.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/no_varience.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def cfa_artifact():
    ...
    if(identical_regions_cfa):
        # Retrieve the output image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/cfa.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # print('\nSingle compressed')
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/no_cfa.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def jpeg_Compression():
    ...
    if(double_compressed):
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/double_compression.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # print('\nSingle compressed')
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("Image_Manipulation_Detection_System_Python-main/images/single_compression.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
root.iconbitmap('Image_Manipulation_Detection_System_Python-main/images/favicon.ico')
...
# Get the blank image
input_img = getImage("Image_Manipulation_Detection_System_Python-main/images/input.png", IMG_WIDTH, IMG_HEIGHT)
middle_img = getImage("Image_Manipulation_Detection_System_Python-main/images/middle.png", IMG_WIDTH, IMG_HEIGHT)
output_img = getImage("Image_Manipulation_Detection_System_Python-main/images/output.png", IMG_WIDTH, IMG_HEIGHT)
